...
def get_args():
    ...
    #! duc code:
    parser.add_argument("--MIM", default=False, action='store_true', help="whether to use Mask Image Modeling dataset")
    parser.add_argument("--patch_dim",type=int,default=64)
    #! ---------
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='sdm+id+mlm+cmt', help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm', 'cmt']")
