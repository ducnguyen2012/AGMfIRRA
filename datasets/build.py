...
from .bases import ImageDataset, TextDataset, ImageTextDataset, ImageTextMLMDataset, ImageTextMIMDataset, ImageTextMaskMultimodalDataset
...
def build_dataloader(args, tranforms=None):
    ...
    if args.training:
        ...
        # if args.MIM:
        #     train_set = ImageTextMIMDataset(dataset.train, 
        #     train_transforms,patch_size = args.patch_size, 
        #     mask_ratio = args.mask_ratio)
        # if args.MIM and args.MLM:
        #     train_set = ImageTextMaskMultimodalDataset(dataset.train,
        #                              train_transforms,
        #                              text_length=args.text_length)
        else:
