...
class ICFGPEDES(BaseDataset):
    ...
    dataset_dir = '/dis/DS/ducanh/person-search/datasets/ICFG-PEDES' #! set up cuhk dataset for t4
    #dataset_dir = '/data2/cmdir/home/giangnl/ducanhCNTT/datasets/CUHK-PEDES' #! set up cuhk dataset for t4
